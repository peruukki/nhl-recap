...
require.register('es6-promise', function (exp, req, mod) {
mod.exports = (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}) ({"/Users/hale/Repos/html/nhl-recap/node_modules/es6-promise/dist/es6-promise.js":[function(require,module,exports){
/*!
...
},{  }]},{},[])('/Users/hale/Repos/html/nhl-recap/node_modules/es6-promise/dist/es6-promise.js'); }) 
 
;require.register('react', function (exp, req, mod) {
mod.exports = (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}) ({"/Users/hale/Repos/html/nhl-recap/node_modules/react/dist/react.js":[function(require,module,exports){
 /**
  * React v0.14.2
  */
...
},{  }]},{},[])('/Users/hale/Repos/html/nhl-recap/node_modules/react/dist/react.js'); }) 
 
;require.register('whatwg-fetch', function (exp, req, mod) {
mod.exports = (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}) ({"/Users/hale/Repos/html/nhl-recap/node_modules/whatwg-fetch/fetch.js":[function(require,module,exports){
(function() {
  'use strict';
...
},{  }]},{},[])('/Users/hale/Repos/html/nhl-recap/node_modules/whatwg-fetch/fetch.js'); }) 
 
;require.register("js/GameScore", function(exports, require, module) {
"use strict";
...
var GameScore = React.createClass({
  ...
  render: function render() {
    var awayTeam = this.props.teams[0];
    var homeTeam = this.props.teams[1];
    return React.createElement(
      "div",
      { className: "game" },
      React.createElement(
        "div",
        { className: "teamPanel away" },
        React.createElement(
          "span",
          { className: "teamName" },
          awayTeam
      ...
      React.createElement(
        "div",
        { className: "teamPanel home" },
        React.createElement(
          "span",
          { className: "teamScore" },
          this.props.scores[homeTeam]
        ),
        React.createElement(
          "span",
          { className: "teamName" },
...
require.register("js/ScoreList", function(exports, require, module) {
'use strict';
...
var ScoreList = React.createClass({
  ...
  render: function render() {
    var games = this.props.scores ? this.props.scores.map(function (game) {
      return React.createElement(GameScore, {
        key: game.teams[0],
        scores: game.scores,
        teams: game.teams
      });
...
require.register("js/ScorePanel", function(exports, require, module) {
'use strict';

var React = require('react');
var ScoreList = require('./ScoreList');

require('es6-promise');
require('whatwg-fetch');

var ScorePanel = React.createClass({
  displayName: 'ScorePanel',
  ...
  componentDidMount: function componentDidMount() {
    ...
    fetch('https://nhlscoreapi-peruukki.rhcloud.com/api/scores/latest').then(this.throwOnHTTPErrorStatus).then(function (res) {
      return res.json();
    }).then(function (res) {
      if (_this.isMounted()) {
        _this.setState({ scores: res, status: null });
      }
    })['catch'](function (err) {
      return _this.setState({ status: 'Failed to fetch latest scores: ' + err.message });
    });
  },
  throwOnHTTPErrorStatus: function throwOnHTTPErrorStatus(res) {
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(ScoreList, { scores: this.state.scores }),
      React.createElement(
        'div',
        { className: 'status' },
        this.state.status
...
require.register("js/initialize", function(exports, require, module) {
'use strict';

var React = require('react');
var ScorePanel = require('./ScorePanel');

React.render(React.createElement(ScorePanel, null), document.getElementById('app'));
