  ...
  const goals: GoalWithUpdateFields[] = [
    {
      ...
      sec: 5,
      team: 'FLA',
      scorer: { player: 'Alexander Barkov', playerId: 8477493, seasonTotal: 6 },
      assists: [],
      gameIndex: 2,
      classModifier: 'home',
    },
    {
      ...
      sec: 2,
      team: 'CHI',
      scorer: { player: 'Patrik Kane', playerId: 8474141, seasonTotal: 3 },
      assists: [],
      gameIndex: 3,
      classModifier: 'home',
    },
    {
      period: 'SO',
      team: 'TOR',
      scorer: { player: 'Leo Komarov', playerId: 8473463, seasonTotal: 2 },
      gameIndex: 0,
      classModifier: 'home',
    },
    {
      period: 'SO',
      team: 'TOR',
      scorer: { player: 'Martin Marincin', playerId: 8475716, seasonTotal: 1 },
      gameIndex: 0,
      classModifier: 'home',
    },
    {
      period: 'SO',
      team: 'SJS',
      scorer: { player: 'Joe Pavelski', playerId: 8470794, seasonTotal: 5 },
      gameIndex: 1,
      classModifier: 'away',
    },
  ];
