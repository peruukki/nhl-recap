...
The tool requires `sharp` for image processing. Install it by running:
...
2. The tool counts non-transparent pixels (filled area)
3. Visual weight = filled pixels / total pixels
